...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://api.resend.com https://api.coingecko.com wss://stream.binance.com:443 https://*.jivosite.com wss://*.jivosite.com https://*.tawk.to wss://*.tawk.to",
      "frame-src https://*.jivosite.com https://*.tawk.to",
